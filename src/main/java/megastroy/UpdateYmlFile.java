...
public class UpdateYmlFile {
    public static void main(String[] args) {
        try {
            // Загружаем XML файл
            File inputFile = new File("C:\\Users\\iaros\\OneDrive\\Рабочий стол\\kazan_new.xml");
            ...
            for (int i = 0; i < offersList.getLength(); i++) {
                ...
                String newUrl = "http://${URL_HOST()}:3456/castlemock/mock/rest/project/doc9TU/application/vVr2SX/item.html?aid=${QUERY_STRING(query=\"aid\")}&amp;itemid=" + itemId;
            ...
            StreamResult result = new StreamResult(new File("C:\\Users\\iaros\\OneDrive\\Рабочий стол\\kazan_new.xml"));
